...
export const appEnvSchema = z.object({
  ...
  AUTOMATION_MODE: z.enum(["DRY_RUN", "REVIEW_REQUIRED", "AUTOPILOT"]).default("AUTOPILOT"),
  AUTOPILOT_MIN_SCORE: z.coerce.number().int().min(0).max(100).default(60),
  ...
  AUTO_SUBMIT_ONLY_WITH_CLEAR_SCOPE: booleanFromEnv.default(false),
  ...
  REJECT_UNCLEAR_SCOPE_WHEN_AUTOPILOT: booleanFromEnv.default(false),
